...
React Native JavaScript cannot call these APIs directly. Bridge them from native iOS (AppDelegate) the same way the Android React Native module wraps `Sharpsell.INSTANCE`.
:::
